...
export default function Navbar({ darkMode, onToggleDark }: { darkMode: boolean; onToggleDark: () => void }) {
  ...
  return (
    <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:"20px", position:"relative", zIndex:100 }}>
      ...
      {/* Logo — uses real icon-192.png */}
      <AppLogo size={38} showText={true} />
          ...
          <div ref={dropRef} style={{ position:"relative" }}>
            ...
            {open && (
              <div style={{
                ...
                border:"1px solid #f0f0f0", overflow:"hidden", zIndex:9999,
                ...
                <Link href="/profile" onClick={() => setOpen(false)} style={{ display:"block", padding:"16px", background:"linear-gradient(135deg,#fff8f5,#fff)", borderBottom:"1px solid #f5f5f5", textDecoration:"none" }}>
                  ...
                  <div style={{ padding:"7px 12px", borderRadius:"10px", backgroundColor:"#fff8f5", display:"flex", justifyContent:"space-between" }}>
