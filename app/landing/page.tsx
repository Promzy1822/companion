      ...
      <div style={{ background: "linear-gradient(160deg,#431407,#7c2d12,#c2410c,#ea580c)", flex: 1, display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ padding: "20px 24px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <img src="/icon-192.png" alt="Companion" width={36} height={36} style={{ borderRadius: "10px" }} />
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", padding: "20px 24px", textAlign: "center" }}>
          <div style={{ margin: "0 auto 24px", width: "90px", height: "90px", borderRadius: "24px", boxShadow: "0 12px 40px rgba(0,0,0,0.3)" }}>
            <img src="/icon-512.png" alt="Companion" width={90} height={90} style={{ borderRadius: "24px", display: "block" }} />
          </div>
          <div style={{ display: "inline-block", margin: "0 auto 16px", padding: "6px 16px", borderRadius: "20px", backgroundColor: "rgba(255,255,255,0.15)", color: "rgba(255,255,255,0.9)", fontSize: "13px", fontWeight: "600" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.85)", fontSize: "15px", lineHeight: "1.6", margin: "0 0 32px" }}>
            Learn smarter, practice daily, and get instant answers. Built for Nigerian students.
          </p>
          <Link href="/auth" style={{ display: "block", padding: "18px", borderRadius: "30px", backgroundColor: "#fff", color: "#c2410c", fontWeight: "800", fontSize: "17px", textDecoration: "none", boxShadow: "0 8px 32px rgba(0,0,0,0.25)", marginBottom: "12px" }}>
            Get Started Free →
          </Link>
