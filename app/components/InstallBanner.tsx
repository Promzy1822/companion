...
export default function InstallBanner() {
  ...
  const dismiss = () => { setShow(false); localStorage.setItem("pwa_dismissed_at", String(Date.now())); };
  ...
  return (
    <>
      <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 9999, animation: "slideUp 0.4s cubic-bezier(0.34,1.56,0.64,1)" }}>
        <div style={{ margin: "12px", borderRadius: "20px", background: "linear-gradient(135deg,#1c1c1e,#2c1810)", padding: "16px 18px", display: "flex", alignItems: "center", gap: "14px", boxShadow: "0 8px 40px rgba(0,0,0,0.5)", border: "1px solid rgba(234,88,12,0.4)" }}>
          <img src="/icon-192.png" alt="Companion" width={48} height={48} style={{ borderRadius: "14px", flexShrink: 0 }} />
          <div style={{ flex: 1 }}>
